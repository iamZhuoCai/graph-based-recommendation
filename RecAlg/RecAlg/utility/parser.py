...
def parse_args():
    parser = argparse.ArgumentParser(description="Run RecAlg.")
    ...
    parser.add_argument('--dataset', nargs='?', default='Yelp',
                        help='Choose a dataset from {Gowalla, Yelp, amazon-book, Movielens-1M, Foursquare}')
    ...
    parser.add_argument('--model_type', nargs='?', default='SCF',
                        help='Specify the name of model (GCMC, NGCF, LightGCN, LRGCCF, BPR, SCF).')
